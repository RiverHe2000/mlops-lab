# Monitoring report — window `quality_unseen-01`

**Status: WARN · Action: INVESTIGATE** — 1000 rows, model versions {'v1': 1000}, generated 2026-09-06T00:57:28+00:00
...
| c_region | categorical | 1000 | 0.0% | 0.005 | chi2 | 0.769 | 0.001 | VIC -2.5 pp, unseen 4.1 % |
...
- c_region: unseen_category = 0.0410 (threshold 0.0200) new values ['TAS']

## Performance

- 1000 labels (100% coverage): AUC 0.797, KS 0.459, Brier 0.173, ECE 0.038, positive rate 35.5%
